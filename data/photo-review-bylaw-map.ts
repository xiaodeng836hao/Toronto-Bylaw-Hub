...
export const photoReviewBylawMap: BylawMatchCategory[] = [
  ...
  },
  {
    ...
    triggerKeywords: [
      ...
      "parking pad", "parking on lawn", "commercial parking", "commercial vehicle", "recreational vehicle parking",
      "rv parking", "trailer parking", "boat parking", "vehicle storage",
      "hvac", "air conditioner", "heat pump", "ac unit", "accessory structure", "shed", "detached garage",
      "pergola", "landscaping", "paved front yard", "paved yard", "setback", "driveway widening", "boulevard parking",
    ],
    aiLabels: [
      "zoning", "parking", "front yard parking", "side yard parking", "rear yard parking",
      "commercial parking", "commercial vehicle", "recreational vehicle parking", "rv", "trailer", "boat",
      "hvac", "air conditioner", "accessory structure", "shed", "landscaping",
    ],
    ...
    nextSteps: [
      "Open the Zoning guide (Parking guide for vehicle/parking concerns, Landscaping page for paved-yard concerns)",
