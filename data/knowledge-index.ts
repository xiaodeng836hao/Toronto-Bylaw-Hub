...
export const knowledgeItems: KnowledgeItem[] = [
  ...
  },
  {
    ...
    keywords: ["parking", "front yard parking", "park on lawn", "parking pad", "driveway", "widen driveway", "boulevard parking", "side yard parking", "rear yard parking", "paved yard"],
    synonyms: ["front yard parking", "park on grass", "parking pad", "lawn parking", "front pad", "parking in yard", "driveway widening"],
    relatedQuestions: ["Can I park on my front lawn?", "Can I add a front-yard parking pad?", "Can I widen my driveway?"],
    sourceText:
  ...
  },
  {
    ...
    title: "Can I park in my rear yard or backyard?",
    type: "Zoning",
    topic: "Parking",
    summary:
      "A limited number of outdoor parking spaces are allowed in the rear yard of certain houses, subject to lawful access and the rear-yard soft-landscaping minimum.",
    keywords: ["rear yard parking", "backyard parking", "park in backyard", "rear lane parking", "parking behind house", "detached garage parking"],
    synonyms: ["backyard parking", "back yard parking", "park behind house", "rear parking pad", "lane parking"],
    relatedQuestions: ["Can I park in my backyard?", "Does a rear lane change the parking rules?", "Can a rear yard be fully paved for parking?"],
    sourceText:
      "By-law 569-2013, 10.5.80.10(7): on a lot with a detached house, semi-detached house or duplex, a maximum of 2 parking spaces may be located outside in the rear yard. Where the lot abuts a lane, access must be from the lane (10.10.80.40).",
    plainLanguageAnswer:
      "Often yes, within limits. On a lot with a detached/semi-detached house or duplex, up to 2 outdoor parking spaces may be located in the rear yard. Access usually has to be lawful (frequently from a rear lane), and at least 50% of the rear yard (25% on very narrow lots) must remain soft landscaping — so it can't be fully paved. See the Parking Guide. Parking compliance depends on the exact property, zoning category, layout, vehicle type, and measurements.",
    relatedChapter: `${ZBL} — Chapter 10.5`,
    relatedSections: ["10.5.80.10(7)", "10.5.50.10(3)"],
    officialSources: [SRC_ZONING_REVIEW, SRC_ZONING_MAP],
    internalUrl: "/zoning/parking#rear-yard-parking",
    lastReviewed: REVIEWED,
    cautionLevel: "property-specific",
    nextSteps: [
      "Open the Parking Guide (rear yard parking).",
      "Confirm whether your lot has lawful lane or driveway access.",
      "Keep the required rear-yard soft landscaping.",
    ],
  },
  {
    id: "commercial-recreational-parking",
    title: "Can I park a commercial vehicle, trailer, or RV?",
    type: "Zoning",
    topic: "Parking",
    summary:
      "On a residential lot, commercial vehicles are tightly restricted and larger vehicles aren't permitted outdoors; recreational vehicles follow the same location rules, and size limits need verification.",
    keywords: ["commercial parking", "commercial vehicle", "work truck", "dump truck", "recreational vehicle parking", "rv parking", "trailer parking", "boat parking", "camper parking", "vehicle storage"],
    synonyms: ["commercial vehicle parking", "rv", "trailer", "boat", "camper", "motorhome", "store trailer", "store boat", "park work truck"],
    relatedQuestions: ["Can I park an RV in my driveway?", "Can I store a trailer in my yard?", "Are commercial vehicles treated differently?"],
    sourceText:
      "By-law 569-2013, 10.5.80.10(9)–(10): on a residential lot a commercial vehicle may be parked only if an owner/tenant operates it and it is inside a wholly enclosed building; an outdoor space may not be used for commercially licensed vehicles, construction vehicles, dump trucks, tow/repair vehicles, or vehicles with more than six wheels.",
    plainLanguageAnswer:
      "Commercial vehicles are tightly restricted on residential lots — generally only inside a wholly enclosed building, and never outdoors for commercially licensed, construction, or large (more-than-six-wheel) vehicles. Recreational vehicles (RVs, trailers, campers, boats) follow the same parking-location rules, and larger units may fall under the outdoor-vehicle restriction; RV/trailer/boat size limits are not set in the reviewed source and need verification. See the Parking Guide. Parking compliance depends on the exact property, zoning category, layout, vehicle type, and measurements.",
    relatedChapter: `${ZBL} — Chapter 10.5`,
    relatedSections: ["10.5.80.10(9)", "10.5.80.10(10)"],
    officialSources: [SRC_ZONING_REVIEW, SRC_ZONING_MAP],
    internalUrl: "/zoning/parking#commercial-parking",
    lastReviewed: REVIEWED,
    cautionLevel: "property-specific",
    nextSteps: [
      "Open the Parking Guide (commercial / recreational vehicle parking).",
      "Confirm the vehicle type and where it would be parked.",
      "Verify any size limit with the City — it is not set in the reviewed source.",
    ],
  },
  {
    id: "hvac-ac-location",
...
export const synonymGroups: string[][] = [
  ...
  ["parking", "front yard parking", "side yard parking", "rear yard parking", "backyard parking", "parking pad", "park on lawn", "park on grass", "front pad", "driveway", "widen driveway", "boulevard parking"],
  ["commercial parking", "commercial vehicle", "work truck", "dump truck", "vehicle storage"],
  ["recreational vehicle parking", "rv parking", "rv", "trailer parking", "trailer", "boat parking", "boat", "camper parking", "camper", "motorhome"],
