...
export const zoningTopicDetails: Record<string, ZoningTopicDetail> = {
  ...
  "front-yard-parking": {
    applicableZones: R_AND_RD,
    whyItMatters:
      "Where you may park depends on the yard (front, side, or rear), the zoning category, the vehicle type, and lawful access. Front-yard and street-facing side-yard parking are tightly limited, the rear yard allows a few outdoor spaces, and commercial and recreational vehicles have extra restrictions — to protect landscaping, drainage, and sightlines. Open the dedicated Parking Guide for the full breakdown.",
    relevantSections: [
      { zone: "R & RD", chapter: "Chapter 10.5", section: "10.5.80.10", title: "Parking — Location (front, rear & commercial vehicles)", plainRule: "A parking space may not be in a front yard or a street-facing side yard, except on a private driveway leading to a parking space (detached/semi-detached house or duplex, and certain townhouses). Up to 2 outdoor spaces are allowed in the rear yard. Commercial vehicles may be parked only inside a wholly enclosed building, and larger commercial/construction vehicles are not permitted in outdoor spaces." },
      { zone: "R", chapter: "Chapter 10.10 (R)", section: "10.10.80.40", title: "Access to Parking on Narrow / Corner Lots", plainRule: "On a lot with frontage 7.6 m or less, a garage/vehicle entrance through the front wall is not permitted. On a corner lot or a lot abutting a lane, parking must be accessed from the flanking street or the lane." },
      { zone: "R & RD", chapter: "Chapter 10.5", section: "10.5.50.10", title: "Front & Rear Yard Landscaping (paving limit)", plainRule: "The front-yard landscaping minimums (50–60% landscaping, 75% of it soft) and the rear-yard soft-landscaping minimum limit how much of a yard can be paved for parking." },
    ],
    questions: [
      { question: "Can I park on my front lawn?", answer: "Generally no. A parking space can't be in the front yard or a street-facing side yard. You may park on a legal private driveway that leads to a parking space, but parking on grass or an unpaved front yard is not permitted.", nextStep: "Open the Parking Guide; a new front-yard driveway or pad usually needs City approval." },
      { question: "Can I park in my backyard or beside my house?", answer: "Up to 2 outdoor parking spaces are allowed in the rear yard of a detached/semi-detached house or duplex, subject to lawful access and the soft-landscaping minimum. A street-facing side yard can't be a parking space; an interior side yard isn't clearly addressed in the source and needs verification.", nextStep: "See the Parking Guide for side- and rear-yard details." },
      { question: "Can I park a commercial vehicle, trailer, or RV?", answer: "On a residential lot, a commercial vehicle may only be parked inside a wholly enclosed building, and larger vehicles (e.g. more than six wheels) aren't permitted outdoors. Recreational vehicles follow the same location rules; size limits aren't set in the reviewed source and need verification.", nextStep: "Open the Parking Guide for the commercial and recreational vehicle sections." },
    ],
    examples: [
      ...
      "Storing a dump truck or a vehicle with more than six wheels outdoors on a residential lot is generally not permitted.",
    ],
  },
