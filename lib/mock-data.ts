...
export const bylawChapters: BylawChapter[] = [
  ...
  },
  {
    ...
    tags: [
      "graffiti", "vandalism", "removal", "defacement",
      "graffiti prevention", "prevent graffiti", "graffiti vandalism", "anti graffiti coating",
      "security camera graffiti", "lighting graffiti prevention", "legal mural", "mural exemption",
      "graffiti art exemption", "graffiti exemption", "graffitiexemption", "streetartoronto",
      "support mural program", "graffiti funding", "mural funding", "property owner permission",
