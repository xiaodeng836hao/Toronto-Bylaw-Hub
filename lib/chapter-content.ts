...
export const chapterContent: Record<string, ChapterContent> = {
  ...
  "447": {
    ...
    plainLanguageOverview:
      "Chapter 447 sets the rules for fences on private property. The maximum height depends on the property type (residential vs non-residential), where the fence sits on the lot (front yard vs elsewhere, near a street or driveway), and the fence type — and a hedge or shrub that acts like a fence counts too. The chapter also limits certain materials, requires open (see-through) fencing near driveways, and sets a separate rule for fences on decks. Swimming pool enclosures are part of Chapter 447 but are covered on the Pool Fence Guide.",
    keyRequirements: [
      { title: "Height depends on location and property type", plainLanguageExplanation: "Maximum height comes from Table 1 (below) and changes with the yard, what the fence is near, and whether the property is residential or non-residential.", sectionReference: "§ 447-1.2B (Table 1)", complianceExample: "A typical backyard fence at or under 2.0 m (residential).", nonComplianceExample: "A 2 m solid fence by the front sidewalk, where the limit is 1.2 m." },
      { title: "How fence height is measured", plainLanguageExplanation: "Measured from the average grade level 1 m out on each side of the fence. Different parts of one fence can have different limits.", sectionReference: "§ 447-1.2B(1), (2)", complianceExample: "Averaging the ground level on both sides before building.", nonComplianceExample: "Assuming one limit for a fence that crosses two yard types." },
      { title: "Hedges and vegetation can count as a fence", plainLanguageExplanation: "A hedge or shrub that screens or divides land is treated as a fence and has its own height column in Table 1.", sectionReference: "§ 447-1.1; § 447-1.2B", complianceExample: "Trimming a front-yard hedge near the sidewalk to 1.2 m.", nonComplianceExample: "A 2 m hedge along the front-yard street edge (limit 1.2 m)." },
      { title: "Fences used as guards must stay safe", plainLanguageExplanation: "A fence acting as a guard (e.g. at a raised deck edge) must also meet Chapter 629; where rules overlap, the stricter one applies.", sectionReference: "§ 447-1.2E", complianceExample: "A secure, well-maintained deck-edge guard.", nonComplianceExample: "A loose or collapsing guard at a raised deck." },
      { title: "Site-specific exemptions", plainLanguageExplanation: "A fence required by a site plan or other law is exempt from conflicting rules; otherwise you can request a site-specific exemption from community council.", sectionReference: "§ 447-1.5", complianceExample: "Getting an approved exemption before keeping a non-standard fence.", nonComplianceExample: "Assuming a non-compliant fence is allowed without approval." },
    ],
    practicalComplianceSteps: [
      { title: "Locate the fence", description: "Note the yard (front/side/rear), and whether it's on a deck or near a driveway — location sets the height limit." },
      { title: "Confirm the property type", description: "Residential and non-residential limits differ on several Table 1 rows." },
      { title: "Check Table 1", description: "Use the height table and helper below to find your row and maximum height, measuring from average grade 1 m out on each side." },
      { title: "Avoid prohibited materials", description: "No sheet/corrugated metal, barbed/sharp material, or electric fencing (except low-voltage livestock fencing on farmland)." },
      { title: "Keep driveways visible", description: "Within 2.4 m of a driveway, use open (see-through) fencing and don't let plants block it." },
      { title: "Pools use the Pool Fence Guide", description: "For a pool, hot tub, or spa enclosure, follow the Pool Fence Guide instead.", caution: "Pool enclosure rules exist to prevent drowning — don't rely on the general fence rules for a pool." },
    ],
    commonQuestions: [
  ...
  "485": {
    complexityLevel: "simple",
    plainLanguageOverview:
      "Chapter 485 prohibits graffiti vandalism and requires property owners and occupants to keep their property free of it. Approved art murals and graffiti art are treated differently — they can be 'regularized' or granted a graffiti exemption through the City's Graffiti Art in the City (StreetARToronto) program so they aren't considered vandalism. The City can issue a notice to remove graffiti and, if it isn't removed, can remove it and recover the cost.",
    keyRequirements: [
      ...
      { title: "Graffiti exemption for approved graffiti art", plainLanguageExplanation: "Genuine 'graffiti art' — markings that aesthetically enhance the surface and have the property owner's consent — can be recognized as art rather than vandalism and exempted from the removal requirement. A property owner can request this through the City's Graffiti Art in the City (StreetARToronto) program, and the City reviews each request. An exemption is not automatic and does not cover unapproved tags.", sectionReference: "Chapter 485, §§ 485-1, 485-6 · City 'Graffiti Art in the City' program", complianceExample: "Applying for a graffiti exemption for an owner-approved mural or artistic piece.", nonComplianceExample: "Treating any spray-paint as exempt 'art' without an approved exemption." },
    ],
    practicalComplianceSteps: [
    ...
    commonQuestions: [
      ...
      { question: "How do I get graffiti art exempted from the removal requirement?", answer: "The property owner can apply to have approved graffiti art on the property recognized and exempted so it is not treated as vandalism subject to removal. This is handled through the City's 'Graffiti Art in the City' (StreetARToronto) program, and each request is reviewed against the City's criteria. Confirm the current requirements and how to apply on the official City page.", sectionReference: "§§ 485-1, 485-6", practicalNextStep: "Open the 'Approved Graffiti Art in the City' page linked on this page and apply for a graffiti exemption with the owner's consent." },
    ],
    relatedTopics: [PHOTO_REVIEW, T311, { label: "Approved Graffiti Art in the City", href: "https://www.toronto.ca/city-government/public-notices-bylaws/bylaw-enforcement/graffiti-postering-signs/graffiti-art-in-the-city/", external: true }, { label: "Official Chapter 485", href: "https://www.toronto.ca/legdocs/municode/1184_485.pdf", external: true }],
