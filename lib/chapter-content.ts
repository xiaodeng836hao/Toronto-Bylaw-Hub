...
export const chapterContent: Record<string, ChapterContent> = {
  ...
  // ── 447 — Fences ───────────────────────────────────────────────────────────
  //  V3.6: focused on GENERAL fence requirements. Detailed swimming pool
  //  ENCLOSURE content (§ 447-1.3) lives on the dedicated Pool Fence Guide.
  //  The fence height TABLE, the Fence Height Helper, general restrictions,
  //  driveway visibility, deck fences, and the pool redirect are rendered from
  //  lib/fence-447.ts in the chapter page (slug === "447").
  "447": {
    complexityLevel: "complex",
    plainLanguageOverview:
      "Chapter 447 sets the rules for fences on private property in Toronto. A 'fence' is broadly defined — any barrier or structure (other than a part of a building) that screens, encloses, or divides a yard or marks a boundary — and it expressly includes a hedge or shrub that has the same effect. The maximum height of a fence depends on three things: the type of property (single/multiple residential vs non-residential), where the fence is on the lot (front yard vs other), and the type of fence (a solid fence, a hedge, or a recreational fence). The chapter also limits certain materials, requires open-fence construction near driveways, and sets special rules for fences on decks. Swimming pool enclosures are also part of Chapter 447, but those detailed safety and permit rules are covered separately on the Pool Fence Guide.",
    keyRequirements: [
      { title: "Fence height depends on location and property type", plainLanguageExplanation: "Maximum fence height is set by Table 1. It varies by where the fence is (front yard vs elsewhere, near a public-highway lot line, near a driveway, on a deck, abutting other property types) and by whether the property is residential or non-residential. See the Fence Height Requirements table below.", sectionReference: "§ 447-1.2B (Table 1)", complianceExample: "A standard backyard fence between two houses kept at or under 2.0 m (residential, Item 9).", nonComplianceExample: "A 2.2 m solid fence right along the front sidewalk, where the limit near a public-highway lot line is 1.2 m." },
      { title: "How fence height is measured", plainLanguageExplanation: "Height is measured at any point along the fence from the average grade level measured perpendicular to, and one metre away on either side of, the fence. If different parts of one fence match different Table 1 rows, each part is treated as a separate fence for height.", sectionReference: "§ 447-1.2B(1), (2)", complianceExample: "Measuring at the highest point and averaging grade on both sides before building.", nonComplianceExample: "Assuming a single height limit applies to a fence that runs through a front yard and a side yard." },
      { title: "Allowed fence materials", plainLanguageExplanation: "Fences must be built of materials usually intended for permanent fencing — for example wood, chain-link, metal picket, masonry, or glass panels built in a good, workmanlike manner.", sectionReference: "§ 447-1.2A(5)", complianceExample: "A pressure-treated wood privacy fence on sound posts.", nonComplianceExample: "A 'fence' cobbled together from pallets, tarps, or salvaged material not meant for permanent fencing." },
      { title: "Prohibited materials: barbed/sharp, sheet metal, corrugated metal", plainLanguageExplanation: "Barbed wire, chicken wire, or other barbed or sharp material generally cannot be used (a narrow exception applies only above 2.5 m on 45° inward brackets). Sheet metal and corrugated metal panels are not allowed at all.", sectionReference: "§ 447-1.2A(2), (3)", complianceExample: "A standard wood or chain-link fence with no sharp material.", nonComplianceExample: "A backyard fence built from corrugated metal panels, or topped with barbed wire on a normal-height fence." },
      { title: "Electric fences are generally not allowed", plainLanguageExplanation: "A fence cannot be used to conduct electricity, except on agricultural land actually used to raise livestock — and only at 12 volts or less, designed only to contain livestock, with warning signs at least every 12 m.", sectionReference: "§ 447-1.2A(4)", complianceExample: "Not electrifying a residential fence.", nonComplianceExample: "Wiring a backyard fence to deliver a shock to deter intruders or animals." },
      { title: "Temporary fences and snow fences", plainLanguageExplanation: "Temporary fencing is generally not permitted. The seasonal exception is a snow fence, which may be used on private property only between November 15 and April 15 and must meet the chapter's standards.", sectionReference: "§ 447-1.2A(5), (6)", complianceExample: "Putting up a snow fence in December and taking it down by mid-April.", nonComplianceExample: "Leaving temporary plastic-mesh fencing up year-round as a permanent fence." },
      { title: "Open-fence construction near driveways", plainLanguageExplanation: "Any fence within 2.4 m of a driveway must be open-fence construction (such as open mesh chain-link) for at least 2.4 m from the lot line where the driveway begins, so it does not block the view of the boulevard or highway.", sectionReference: "§ 447-1.2C", complianceExample: "Using chain-link beside the driveway entrance so drivers can see the sidewalk.", nonComplianceExample: "A tall solid fence right beside the driveway that hides approaching pedestrians and cyclists." },
      { title: "Fences on unroofed decks", plainLanguageExplanation: "On an attached, unroofed deck (not in a front yard, not within 2.4 m of a public-highway lot line), a fence may be up to 2.0 m measured above the deck surface. If it also acts as a guard, it must meet Chapter 629 as well.", sectionReference: "§ 447-1.2B (Table 1, Item 5)", complianceExample: "A 2.0 m privacy screen measured from the deck floor on a raised back deck.", nonComplianceExample: "A deck privacy wall well above 2.0 m measured from the deck surface." },
      { title: "Hedges and vegetation can count as a fence", plainLanguageExplanation: "The definition of 'fence' includes a hedge or shrub that screens, encloses, or divides land the same way a fence would. Table 1 has a separate height column for hedges and vegetation — in several positions there is 'no maximum', but near a public-highway lot line the same limits apply.", sectionReference: "§ 447-1.1 (definition); § 447-1.2B (Table 1)", complianceExample: "Keeping a front-yard hedge near the sidewalk trimmed to 1.2 m.", nonComplianceExample: "A dense 2 m hedge along the front-yard street edge where the limit is 1.2 m." },
      { title: "Fences used as guards must stay safe", plainLanguageExplanation: "Where a fence is used as a guard (for example at the open side of a raised deck), it must be installed and maintained to comply with Chapter 629, Property Standards. Where more than one by-law applies, the more restrictive requirement governs.", sectionReference: "§ 447-1.2E", complianceExample: "Keeping a deck-edge guard solid, secure, and in good repair.", nonComplianceExample: "A loose or collapsing guard at the open side of a raised deck." },
      { title: "Site-specific exemptions", plainLanguageExplanation: "A fence required by a site plan, subdivision agreement, or other law is exempt from conflicting parts of this chapter. Otherwise, an owner may request a site-specific exemption from Council or community council (with an application fee and notice to neighbours).", sectionReference: "§ 447-1.5", complianceExample: "Requesting a community-council exemption before keeping a non-standard fence.", nonComplianceExample: "Assuming any non-compliant fence is automatically allowed without an approved exemption." },
    ],
    practicalComplianceSteps: [
      { title: "Identify where the fence will be", description: "Note whether it's in a front yard, side yard, rear yard, on a deck, or in a driveway visibility area — location drives the height limit." },
      { title: "Confirm the property type", description: "Single/multiple residential and non-residential properties have different limits in several Table 1 rows." },
      { title: "Check the height limit in Table 1", description: "Use the Fence Height Requirements table and the Fence Height Helper below to find the likely row and maximum height." },
      { title: "Measure from average grade", description: "Measure height from the average grade level perpendicular to and one metre away on either side of the fence." },
      { title: "Avoid prohibited materials", description: "No sheet metal, corrugated metal panels, barbed/sharp material (except the narrow high-fence exception), or electrified fencing off agricultural land." },
      { title: "Consider driveway visibility", description: "Within 2.4 m of a driveway, use open-fence construction so sightlines stay clear.", caution: "Don't let a hedge or objects grow into and block a fence that must stay open for visibility." },
      { title: "Avoid temporary fencing", description: "Don't use temporary fencing as a permanent fence; snow fences are only allowed Nov 15 – Apr 15." },
      { title: "Keep records", description: "Keep photos, drawings, measurements, and contractor details in case questions come up later." },
      { title: "Check the official bylaw before building", description: "Confirm the exact requirement and any exemptions in Chapter 447 (or with City staff) before construction." },
      { title: "Pools use the Pool Fence Guide", description: "If the fence is for a swimming pool, hot tub, spa, or pool enclosure, use the Pool Fence Guide instead — those rules are different.", caution: "Pool enclosure safety rules exist to prevent drowning — don't rely on the general fence rules for a pool." },
    ],
    commonQuestions: [
      { question: "How high can my front yard fence be?", answer: "In a front yard, within 2.4 m of a lot line abutting a public highway (not a lane), the limit is 1.2 m. Set back more than 2.4 m from that lot line, a front-yard fence may be up to 2.0 m. The same applies to residential and non-residential property in the front yard.", sectionReference: "§ 447-1.2B, Table 1, Items 1–2", practicalNextStep: "Measure how far the fence sits from the street-side lot line, then use the table or helper below." },
      { question: "How high can my backyard fence be?", answer: "A typical rear-yard fence falls under the catch-all row at up to 2.0 m on residential property (Item 9). It can be up to 2.5 m where it abuts a multi-residential property, a non-residential property, a public highway, or a public walkway (Item 6).", sectionReference: "§ 447-1.2B, Table 1, Items 6 & 9", practicalNextStep: "Check what your rear fence backs onto to see whether the 2.5 m row applies." },
      { question: "Does the height limit change for residential vs non-residential properties?", answer: "For several rows, yes. For example, the catch-all row allows 2.0 m on residential but 2.5 m on non-residential property, and the rapid-transit and recreational rows differ too. Other rows (like the front-yard rows) are the same for both.", sectionReference: "§ 447-1.2B, Table 1", practicalNextStep: "Read the matching row across the residential and non-residential columns in the table below." },
      { question: "How is fence height measured?", answer: "Height is measured at any point along the fence from the average grade level measured perpendicular to, and one metre away on either side of, the fence.", sectionReference: "§ 447-1.2B(1)", practicalNextStep: "Average the ground level on both sides before comparing to the limit." },
      { question: "Can I use sheet metal or corrugated metal panels?", answer: "No. Sheet metal and corrugated metal panels are not allowed in any fence.", sectionReference: "§ 447-1.2A(3)", practicalNextStep: "Choose a permitted material such as wood, chain-link, or metal picket." },
      { question: "Can I use barbed wire or sharp materials?", answer: "Generally no. Barbed wire, chicken wire, or other barbed/sharp material is only allowed where the fence is permitted to exceed 2.5 m and the sharp material is installed at 2.5 m or higher on 45° inward-angled brackets — not on a normal residential fence.", sectionReference: "§ 447-1.2A(2)", practicalNextStep: "Keep barbed/sharp material off a standard fence." },
      { question: "Can I install an electric fence?", answer: "Generally no. A fence can't be used to conduct electricity except on agricultural land actually used to raise livestock, at 12 volts or less, designed only to contain livestock, with warning signs at least every 12 m.", sectionReference: "§ 447-1.2A(4)", practicalNextStep: "Don't electrify a residential fence." },
      { question: "Can I put a fence close to a driveway?", answer: "Yes, but any fence within 2.4 m of a driveway must be open-fence construction (such as open mesh chain-link) for at least 2.4 m from the lot line where the driveway begins, so it doesn't block the view of the boulevard or highway.", sectionReference: "§ 447-1.2C", practicalNextStep: "Use an open construction beside the driveway entrance and keep vegetation from blocking it." },
      { question: "Can a hedge count as a fence?", answer: "Yes. The definition of 'fence' includes a hedge or shrub that screens, encloses, or divides land the same way a fence would, and Table 1 has a separate height column for hedges and vegetation.", sectionReference: "§ 447-1.1; § 447-1.2B", practicalNextStep: "Treat a boundary hedge like a fence and check the hedge column for your location." },
      { question: "Can I use temporary fencing?", answer: "Generally no — temporary fencing isn't permitted as a regular fence. The exception is a snow fence, which may be used on private property only between November 15 and April 15.", sectionReference: "§ 447-1.2A(5), (6)", practicalNextStep: "Limit snow fences to the Nov 15 – Apr 15 window and remove them after." },
      { question: "Are pool fences covered on this page?", answer: "Swimming pool enclosures are part of Chapter 447 (§ 447-1.3), but their detailed safety and permit requirements — enclosure height, non-climbable surfaces, self-closing/self-latching gates, temporary pool fencing, permit steps, and the inspection checklist — are on the dedicated Pool Fence Guide. This page focuses on general fence requirements.", sectionReference: "§ 447-1.3", practicalNextStep: "Use the Pool Fence Guide for anything related to a pool, hot tub, spa, or pool enclosure." },
    ],
    relatedTopics: [
      { label: "Pool Fence Guide", href: "/pool-fence-guide", description: "Pool enclosure permits, gates, and the inspection checklist." },
      { label: "Zoning Guide", href: "/zoning", description: "Fence-and-zoning overlap, corner-lot sight lines." },
      PHOTO_REVIEW, T311,
      { label: "City of Toronto — Fences", href: "https://www.toronto.ca/city-government/public-notices-bylaws/bylaw-enforcement/fences/", external: true },
      { label: "Official Chapter 447 (PDF)", href: "https://www.toronto.ca/legdocs/municode/1184_447.pdf", external: true },
    ],
    sourceNotes: SOURCE_NOTE("447, Fences") + " Height values are taken from § 447-1.2B, Table 1. Detailed swimming pool enclosure requirements (§ 447-1.3) are covered separately on the Pool Fence Guide.",
